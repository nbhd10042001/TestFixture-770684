...
libcustom_770684::libcustom_770684()
{
    initPinDigital();
    initPinAnalog();
}

void libcustom_770684::initPinDigital()
{
...
void libcustom_770684::initPinAnalog()
{
...
float libcustom_770684::caculateVoltageReadFromADC(int pin)
{
...
float libcustom_770684::analogReadWithSample(int pin)
{
  long total = 0;
  float value = 0;
...
void libcustom_770684::resetActiveRelay()
{
  digitalWrite(D5, LOW);
  digitalWrite(D6, LOW);
  digitalWrite(D7, LOW);
...
bool libcustom_770684::checkStopTest()
{
  for (int i = 0; i < 30; i++)
  {
